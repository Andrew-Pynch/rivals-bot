...
def simulate_bot_outputs():
    action = [-0.7132605, -0.7332335, -0.9402064, 0.83424723, 1, 1, 1, 1, 0, -1]
    vj.open()
    joystickPosition = vj.generateJoystickPosition(wAxisX=0, wAxisY=0)
    vj.update(joystickPosition)


if __name__ == '__main__':
    while True:
        simulate_bot_outputs()
    # ultimate_release()